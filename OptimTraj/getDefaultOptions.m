...
for i=1:length(opt)
    ...
    switch OPT_method
        ...
        case 'euler'
            OPT.euler = defaults_euler(opt(i).defaultAccuracy);    
        case 'rungeKutta'
...
function OPT_euler = defaults_euler(accuracy)

switch accuracy
    case 'low'
        OPT_euler.nSegment = 10;
        OPT_euler.nSubStep = 2;
    case 'medium'
        OPT_euler.nSegment = 20;
        OPT_euler.nSubStep = 2;
    case 'high'
        OPT_euler.nSegment = 20;
        OPT_euler.nSubStep = 4;
    otherwise
        error('Invalid value for options.defaultAccuracy')
end

OPT_euler.adaptiveDerivativeCheck = 'off';
